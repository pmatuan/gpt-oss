...
#define MATMUL_QKV_BLOCK_ROWS 256
#define MATMUL_QKV_BLOCK_COLS 256
#define MATMUL_QKV_BLOCK_DEPTH 32
#define MATMUL_QKV_WARP_TILE_M 128
#define MATMUL_QKV_WARP_TILE_N 32
#define MATMUL_QKV_WAVES_M (MATMUL_QKV_BLOCK_ROWS / MATMUL_QKV_WARP_TILE_M)
#define MATMUL_QKV_WAVES_N (MATMUL_QKV_BLOCK_COLS / MATMUL_QKV_WARP_TILE_N)
#define MATMUL_QKV_WAVES_PER_BLOCK (MATMUL_QKV_WAVES_M * MATMUL_QKV_WAVES_N)

#define MATMUL_ATT_BLOCK_ROWS 128
#define MATMUL_ATT_BLOCK_COLS 128
#define MATMUL_ATT_BLOCK_DEPTH 32
#define MATMUL_ATT_WARP_TILE_M 32
#define MATMUL_ATT_WARP_TILE_N 64
#define MATMUL_ATT_WAVES_M (MATMUL_ATT_BLOCK_ROWS / MATMUL_ATT_WARP_TILE_M)
#define MATMUL_ATT_WAVES_N (MATMUL_ATT_BLOCK_COLS / MATMUL_ATT_WARP_TILE_N)
#define MATMUL_ATT_WAVES_PER_BLOCK (MATMUL_ATT_WAVES_M * MATMUL_ATT_WAVES_N)

#define MATMUL_LOGITS_BLOCK_ROWS 256
#define MATMUL_LOGITS_BLOCK_COLS 256
#define MATMUL_LOGITS_BLOCK_DEPTH 32
#define MATMUL_LOGITS_WARP_TILE_M 128
#define MATMUL_LOGITS_WARP_TILE_N 32
#define MATMUL_LOGITS_WAVES_M                                                    \
  (MATMUL_LOGITS_BLOCK_ROWS / MATMUL_LOGITS_WARP_TILE_M)
#define MATMUL_LOGITS_WAVES_N                                                    \
  (MATMUL_LOGITS_BLOCK_COLS / MATMUL_LOGITS_WARP_TILE_N)
#define MATMUL_LOGITS_WAVES_PER_BLOCK                                            \
  (MATMUL_LOGITS_WAVES_M * MATMUL_LOGITS_WAVES_N)
