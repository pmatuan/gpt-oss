...
#include "matmul_120b.h"
#include <math.h>

// x:[B,n], w:[d,n], y:[B,d]
__global__ void matmul_bias_gemm_kernel_bf16_mfma_120b(
 ...
 * Grid: (ceil(d/TM), B)
 */
__global__ void matmul_bias_gemm_kernel_float_120b(
...
__global__ void mlp1_fused_gemm_kernel_120b(
...
__global__ void mlp2_bias_weighted_accum_gemm_kernel_120b(
